...
public class EmployeeFieldPositionDTO {
    ...
    public EmployeeFieldPositionDTO() {
    }

    public EmployeeFieldPositionDTO(String pmCode, int empNo, String phone, String companyEmail, String name, int age, int positionCode, char gender, String officeNum, int fieldCode, MedicalFieldDTO medicalFieldDTO, PositionDTO positionDTO) {
        this.pmCode = pmCode;
        this.empNo = empNo;
        this.phone = phone;
    ...
    public String toString() {
        return "EmployeeFieldPositionDTO{" +
                "pmCode='" + pmCode + '\'' +
                ", empNo=" + empNo +
                ", phone='" + phone + '\'' +
